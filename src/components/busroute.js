                    ...
                    <div className="card bg-secondaryblack/50 h-full w-10/12 flex justify-center items-center m-auto my-5  rounded-xl p-10">
                        ...
                        <div >
                            ...
                            <div className=" text-fadewhite font-light p-3 sm:flex justify-center items-center">
                                ...
                                <a href={busroutepdf} className="w-full sm:w-2/5 hover:scale-125  flex justify-center items-center  text-md sm:text-md px-1 py-2  text-primaryblack rounded-lg bg-gradient-to-r from-purple via-grad2 to-yellow drop-shadow-2xl " download><button className="">GET OUR BUS ROUTES</button></a>
