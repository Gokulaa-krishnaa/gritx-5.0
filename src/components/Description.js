                ...
                <div className="  h-2/5 w-10/12 mt-6 sm:mt-10 md:w-9/12 bg-gradient-to-r from-[#000000]/70 to-transparent ">
                  <div className=" sm:flex sm:justify-end">
                    <div className="sm:grid sm:grid-cols-2 sm:gap-14 ">
                      <button className=" border-none font-normal sm:text-sm md:text-base lg:text-lg xl:text-xl sm:mt-10 md:px-1 md:py-1 lg:px-3 lg:py-1 rounded-lg bg-gradient-to-r from-[#B760B1] via-[#E36595] to-[#E6BB5B] text-white">
                        GET BROCHURE
                      </button>
                      <button className=" font-semibold md:text-base lg:text-lg xl:text-xl px-4 py-2 sm:mt-10 border-[#229D98] border-4 text-[#229D98]">
                        REGISTER
                      </button>
                    </div>
                  </div>
                ...
                <div className="flex justify-end sm:-mr-24 sm:-ml-10 md:mt-12 lg:mt-1 md:-ml-24 md:-mr-20 ">
                  <div className=" flex justify-end sm:py-8 sm:mr-20 md:mr-24 lg:mr-52 sm:pl-4 sm:h-auto bg-gradient-to-r from-[#000000]/70 to-transparent ">
                    <div className="sm:grid sm:grid-rows-10 sm:pl-2 sm:mr-2 ml-0">
                      <h1 className="text-[#229D98] sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-extrabold">
                        A
                      </h1>
                      <h1 className="text-[#229D98] sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-extrabold">
                        b
                    ...
                    <div className=" sm:w-11/12">
                      ...
                      <div className="sm:grid sm:grid-cols-2 sm:gap-20 sm:pr-6 sm:pt-6">
                        <div>
                          <h1 className="text-[#B760B1] text-center font-bold sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl">
                            03
                          </h1>
                          <h1 className="text-[#229D98] text-center font-bold sm:text-lg md:text-xl lg:text-2xl xl:text-3xl">
                            ROUNDS
                          </h1>
                        </div>
