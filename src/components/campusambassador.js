...
const Campusambassador = () => {
    return (  
        <div className="min-h-fit w-full lg:w-11/12 bg-secondaryblack float-right " id="campusambassadorsection">
            ...
            <h1 className="text-3xl md:text-4xl text-purple border-l-4 hover:border-l-8 font-semibold border-l-gold pl-2"> CAMPUS<br />AMBASSADOR</h1>
            </div>
            <div >
                <div className="card bg-primaryblack/50 h-full w-10/12 grid md:grid-cols-2 justify-center items-center m-auto my-5  rounded-xl p-10">
                    ...
                    <div >
                        ...
                        <div className="button flex flex-col justify-center items-center my-7 md:my-15">
                            ...
                            <a href="https://docs.google.com/forms/d/e/1FAIpQLSdqQLyDbyH56nnnp_5uh3YuF64hOMdGo-PjCIEo_juqFfNJRw/viewform?usp=sf_link" target="_blank" className="w-4/5 sm:w-2/5  text-xs sm:text-md flex justify-center px-5 py-2 m-2 border-palegreen rounded-lg text-palegreen hover:text-primaryblack hover:bg-palegreen border-2 "><button>REGISTER</button></a>
                            
                        </div>
                    </div>
                </div>
            </div>
            <img id="bussection" src={collegegraph} alt="clggrp" className='w-full px-10 sm:px-28 md:px-72'></img>
            </section>
