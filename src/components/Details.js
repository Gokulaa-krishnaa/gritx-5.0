  ...
  return (
    <div>
        ...
        <div className=" w-11/12 sm:w-3/4 h-auto p-10 bg-primaryblack ">
            ...
            <div className="m-auto  grid grid-cols-3 gap-12 mr-3 -ml-3 mt-4 sm:gap-7 sm:pl-0 md:pl-4 lg:pl-28 sm:pt-8  ">
                <div className=" " id="round1btn">
                    ...
                    <img src={layer} alt="" className=" h-3 " id="activelayer1" />
                </div>
                ...
                <div className="" id="round2btn">
                    ...
                    <img src={layer} alt="" className=" h-3 " id="activelayer2"/>
                </div>
                ...
                <div className=" " id="round3btn">
                    ...
                    <img src={layer} alt="" className=" h-3  " id="activelayer3"/>
                </div>
                  ...
                  <div className="m-auto  w-11/12 border-10 bg-[#191919] drop-shadow-lg " >
                    ...
                    <div className="sm:m-7 p-4 " id={e.id} >
                        ...
                        <p className="text-white  text-md md:text-lg lg:text-xl sm:pt-2 md:text-base">
                                ...
                                <br />
                                <br />
                                {e.instructions && instruction.map((ee)=>( <><li>{ee}</li> </> ))}
                                </ul>
                        </p>
                    </div>
                  </div>
